...
git clone --branch v0.1-alpha --depth 1  https://github.com/danbarto/nanoAOD-tools.git PhysicsTools/NanoAODTools
...
python PhysicsTools/NanoAODTools/scripts/nano_postproc.py ./ $INPUTFILENAMES --branch-selection=PhysicsTools/NanoAODTools/python/postprocessing/modules/tW_scattering/keep_and_drop.txt --cut='nJet>0&&(nElectron+nMuon)>0' -I PhysicsTools.NanoAODTools.postprocessing.modules.tW_scattering.ObjectSelection selector2018
