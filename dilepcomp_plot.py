...
plotDir = os.path.expandvars(cfg['meta']['plots']) + '/dilepcomp/'
...
for name in histograms:
    ...
    if not skip:
        ...
        # get axes
        hist.plot1d(histogram[notdata],overlay="dataset", ax=ax, stack=True, overflow='over', clear=False, line_opts=None, fill_opts=fill_opts, error_opts=error_opts, order=['diboson','tW_scattering', 'TTX', 'TTW','ttbar','wjets', 'DY']) #error_opts??
